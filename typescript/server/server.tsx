...
export default (isoTools, __DEVELOPMENT__) => {
  ...
  // const url = process.env.DATABASE_URL || `mongodb://localhost:27017/${DATABASE_NAME}`;
  ...
  */
  function handleInitialRender(req, res) {
    ...
    match({ routes: routes.configure(), location: req.url || '/' }, (error, redirectLocation, renderProps: any) => {
      if (error) {
